<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="U_Add_Questions.aspx.cs" Inherits="Question_Paper_Generator.U_Add_Questions" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br/>
                <div class="add_Q">
                    <asp:DropDownList required="true" ID="DDL1" runat="server">
            ...
            <br/>
                ...
                <br/><br/>
                    <asp:LinkButton ID="LBback" runat="server" href="U_Menu.aspx" OnClick="LBback_Click">Back</asp:LinkButton>
                </div>  
